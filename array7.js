...
// método pop
// let produtos = ['Placa-mãe', 'Processador', 'Memória RAM', 'SSD'];
// let ultimoItem = produtos.pop(); // Remove o último item do array
// console.log("Após pop():", produtos);
// console.log("item removido:", ultimoItem);

// Método shift
// let produtos = ['Placa mãe', 'Processador', 'Memória RAM', 'SSD'];
// let primeiroItem = produtos.shift(); // Remove o primeiro item do array
...
// console.log(produtos) Adiciona itens no início do array
// Método indexOf
// let produtos = ['Placa-Mae', 'Processador', 'Memória RAM', 'SSD'];
...
// método includes
// let produtos = ['Placa-mãe', 'Processador', 'Memória RAM', 'SSD'];
// let temSsd = produtos.includes('SSD'); // Verifica se o item está no array
// let temTeclado = produtos.includes('Teclado'); // Verifica se o item está no array
...
// console.log("Array Original(nãomudou):", produtos);
// Método splice
// let produtos = ['Placa-mãe', 'Processador', 'Memória RAM', 'SSD', 'Placa de Vídeo'];
// produtos.slice(2, 1);
